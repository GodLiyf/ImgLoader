...
import com.example.imgloader.glideimgloader.GlideImageLoader;
import com.example.imgloader.glideimgloader.GlideImageView;
import com.example.imgloader.glideimgloader.ShapeImageView;
import com.example.imgloader.glideimgloader.progress.CircleProgressView;
import com.example.imgloader.glideimgloader.progress.OnGlideImageViewListener;
import com.example.imgloader.glideimgloader.progress.OnProgressListener;
import com.example.imgloader.imgloader.image.SingleImageActivity;

import java.util.Random;

import static com.example.imgloader.imgloader.image.SingleImageActivity.KEY_IMAGE_URL;
import static com.example.imgloader.imgloader.image.SingleImageActivity.KEY_IMAGE_URL_THUMBNAIL;
    ...
    private void line1() {
        image11.loadImage(url1, R.color.placeholder_color).listener(new OnProgressListener() {
            ...
            public void onProgress(String imageUrl, long bytesRead, long totalBytes, boolean isDone, GlideException exception) {
                Log.e("--->image11", "bytesRead: " + bytesRead + " totalBytes: " + totalBytes + " isDone: " + isDone);
            }
        });
